...
class sentence extends StatefulWidget {
  ...
  @override
  _sentenceState createState() => _sentenceState(_start_word_num, _finish_word_num, page_name, file_name);
}
                                  ...
                                  setState(() {
                                    ...
                                    if (right_num.compareTo('1') == 0)
                                    ...
                                    else
                                      {
                                        ...
                                        incorrect++;
                                        wrong_hindi_words.add(snapshot.data[index][0].toString());
                                        wrong_korean_words.add(snapshot.data[index][2].toString());
                                      }
