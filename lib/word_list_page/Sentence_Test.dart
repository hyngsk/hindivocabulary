...
class _SentenceTestState extends State<SentenceTest>
  ...
  _SentenceTestState(int start_word_num, int finish_word_num,
                ...
                body: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Divider(height: vertical_size*0.005,),
                      Expanded(child: Container(
                        padding: EdgeInsets.only(bottom: vertical_size*0.05),
                        child: Row(
                          ...
                          children: [InkWell(
                            ...
                            child: Container(
                              padding: EdgeInsets.symmetric(horizontal: horizontal_size*0.02,vertical: vertical_size*0.03),
                              decoration: BoxDecoration(
                                //borderRadius: BorderRadiusGeometry.lerp(a, b, t)
                                color: Colors.white10,
                              ),
                              child: Icon(Icons.radio_button_unchecked_outlined,size: 50,color: Colors.black,),
                            ),
                          ),
                            Divider(thickness: horizontal_size*0.005,),
                            InkWell(
                              splashColor: Colors.red,
                              child: Container(
                                padding: EdgeInsets.symmetric(horizontal: horizontal_size*0.02,vertical: vertical_size*0.03),
                                ...
                                child: Icon(Icons.clear,size: 60,color: Colors.black,),
                              ),
                            )
