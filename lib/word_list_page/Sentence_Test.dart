...
class _SentenceTestState extends State<SentenceTest> {
              ...
              return SafeArea(
                ...
                body: Container(
                  ...
                  child: PageTurn(
                    ...
                    children: <Widget>[
                      for (var i = 0; i < _total_itemcount; i++)
                        list_sentence[i],
                    ],
                  ),
                ),
  ...
  List<Widget> makeSentenceList(
      List<Widget> sentence_list,
      double vertical_size,
      double horizontal_size,
      String hindiSentence,
      String korean_Right_Sentence,
      String korean_Wrong_Sentence,
      String hindi_word,
      String korean_word,
      String right_num) {
    String right = '';
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Container(
                  padding:
                      EdgeInsets.symmetric(horizontal: horizontal_size * 0.03),
                  alignment: Alignment.center,
                  width: horizontal_size * 0.78,
                ...
                Container(
                  margin:
                      EdgeInsets.symmetric(horizontal: horizontal_size * 0.1),
                  alignment: Alignment.center,
                  width: horizontal_size * 0.78,
                  height: vertical_size * 0.1,
                  child: AutoSizeText(
                    korean_Wrong_Sentence,
                    minFontSize: 20,
                    maxFontSize: 30,
                    maxLines: 3,
                    style: TextStyle(
                ...
                GestureDetector(
                  ...
                  onTap: () {
                    rightAnswer(horizontal_size, vertical_size, right,
                        korean_Right_Sentence, hindi_word, korean_word);
                  },
                ),
                //정답
              ],
  ...
  Widget rightAnswer(double horizontal_size, double vertical_size, String right,
      String korean_Right_Sentence, String hindi_word, String korean_word) {
    return Container(
      child: Column(
        children: [
          SizedBox(
