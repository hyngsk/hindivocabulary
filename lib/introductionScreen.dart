...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget _buildImage(String assetName,var horizontal_size,var vertical_size) {
    ...
    return Align(
      child: Image.asset('pictures/$assetName.jpg', height: vertical_size*0.45,width: horizontal_size, ),
    ...
    return SafeArea(child: IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          ...
          image: _buildImage('introduction/main',horizontal_size,vertical_size),
        ...
        PageViewModel(
          ...
          image: _buildImage('introduction/back_ban',horizontal_size,vertical_size),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "나의 단어, 문장 복습",
          ...
          image: _buildImage('introduction/my_voca_and_my_sentence',horizontal_size,vertical_size),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "나의 단어 삭제하기",
          body:
          "오른쪽으로 스와이프하면 단어 삭제 버튼이 등장합니다.\n복습 후 암기된 단어를 삭제합니다.",
          image: _buildImage('introduction/delete_my_word',horizontal_size,vertical_size),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "힌디 단어장 외우기",
        ...
        PageViewModel(
          ...
          image: _buildImage('introduction/list_form_word_hide_korean',horizontal_size,vertical_size),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "단어 저장하기",
          ...
          image: _buildImage('introduction/list_form_word_save',horizontal_size,vertical_size),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "카드 형식 단어장",
          body:
          "카드를 터치하면 뜻과 예시 문장이 등장합니다.\n아래에서 위로 스와이프하면 나만의 단어가 저장됩니다.",
          image: _buildImage('introduction/one_by_one_word',horizontal_size,vertical_size),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "문장 학습",
          ...
          image: _buildImage('introduction/sentence_test',horizontal_size,vertical_size),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "단어 테스트",
          ...
          image: _buildImage('introduction/voca_test_hindi',horizontal_size,vertical_size),
          decoration: pageDecoration,
        ),
        ...
        PageViewModel(
          title: "시험 결과",
          body:
          "해당 단원 단어 테스트, 문장 학습이 완료되면 점수와 틀린 단어를 볼 수 있습니다.",
          image: _buildImage('introduction/wrong_words_result',horizontal_size,vertical_size),
          decoration: pageDecoration,
        ),
